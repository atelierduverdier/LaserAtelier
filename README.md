...
<p align="center"><img src="resources/icons/chapeau.svg" alt="" width="56"><br><sub><b>v2.78.0</b> — Le petit chapeau en coin de chaque icône est la signature de l'<a href="https://atelierduverdier.fr">Atelier du Verdier</a>.<br>© Atelier du Verdier — licence <a href="LICENSE">LGPL-2.1-or-later</a>.</sub></p>
...
- **Texte (trait simple)** : grave du texte en **police mono-trait** (Hershey Sans 1-stroke, domaine public) — chaque lettre dessinée d'un seul trait par branche, comme un traceur à plume, au lieu d'un contour rempli. Majuscules, minuscules, chiffres et accents ; hauteur et espacements réglables. Crée un objet fil à graver avec **Marquage** (idéal au gros point / défocus).
  ...
  Parmi les 45 : **Verdier — la police de l'atelier, **dessinée trait par trait** par `outils/creer_police_verdier.py` : aucune fonte tierce, donc aucune licence à respecter, et elle porte le **chapeau melon** de la maison en glyphe (tape `¤`) ainsi que les **œ / Œ** que seule Relief SingleLine avait avant elle.
