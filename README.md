...
<p align="center"><img src="resources/icons/chapeau.svg" alt="" width="56"><br><sub><b>v1.20.0</b> — Le petit chapeau en coin de chaque icône est la signature de l'<a href="https://atelierduverdier.fr">Atelier du Verdier</a>.<br>© Atelier du Verdier — licence <a href="LICENSE">LGPL-2.1-or-later</a>.</sub></p>
...
- **Catalogue (planche d'exemples)** : grave en **un seul job** une planche d'exemples de plusieurs modes de gravure — les **styles de Marquage**, le **Texte trait simple**, les **Hachures 2D** (parallèles / croisées), la **Gravure remplie** — chaque bloc titré, avec **aperçu photo** (rendu réaliste, chaque style bien distinct). Une planche de référence à garder une fois les réglages calés. Un bouton dédié grave en plus un exemple de **gravure photo** (photo de démonstration ou la tienne, en lignes calibrées) — fichier à part car rendu raster.
