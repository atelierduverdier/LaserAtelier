...
<p align="center"><img src="resources/icons/chapeau.svg" alt="" width="56"><br><sub><b>v2.99.47</b> — Le petit chapeau en coin de chaque icône est la signature de l'<a href="https://atelierduverdier.fr">Atelier du Verdier</a>.<br>© Atelier du Verdier — licence <a href="LICENSE">LGPL-2.1-or-later</a>.</sub></p>
...
> Ce README décrit l'atelier **tel qu'il fonctionne**. L'historique — ce qui n'allait pas, ce que le bois a dit, ce qui a été essayé et écarté — vit dans le manuel, chapitre 13 «&nbsp;[Journal de l'atelier](docs/Manuel-LaserAtelier.pdf)&nbsp;», 162 entrées avec leurs mesures.
