...
<p align="center"><img src="resources/icons/chapeau.svg" alt="" width="56"><br><sub><b>v1.19.0</b> — Le petit chapeau en coin de chaque icône est la signature de l'<a href="https://atelierduverdier.fr">Atelier du Verdier</a>.<br>© Atelier du Verdier — licence <a href="LICENSE">LGPL-2.1-or-later</a>.</sub></p>
...
- **Catalogue (planche d'exemples)** : grave en **un seul job** une planche d'exemples de plusieurs modes de gravure — les **styles de Marquage**, le **Texte trait simple**, la **Gravure remplie** — chaque bloc titré, avec **aperçu photo** (rendu réaliste). Une planche de référence à garder une fois les réglages calés. La photo tramée est une planche à part (bouton dédié, rendu raster).
